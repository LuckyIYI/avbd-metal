...
def verify_deployment_manifest(context: CheckpointContext) -> None:
...
def arachne_acceptance_failures(report: dict[str, Any],
                                 context: CheckpointContext) -> list[str]:
    """Re-evaluate the revision-6 Arachne task-owned publication gate."""
...
def require_evaluation_report(report: dict[str, Any], context: CheckpointContext,
    ...
    failures = arachne_acceptance_failures(report, context)

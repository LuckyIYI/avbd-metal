...
python3 Tools/normalize_classic_obj.py \
  --input "$INPUT" \
  --output Sources/GPUSimDemos/Assets/classic/stanford-bunny.obj \
...
python Tools/cook_convex_asset.py \
  ...
  --output Sources/GPUSimDemos/Assets/convex/classic/stanford-bunny.avbdconvex.json \
...
python Tools/cook_convex_asset.py \
  ...
  --output Sources/GPUSimDemos/Assets/convex/classic/stanford-dragon.avbdconvex.json \
...
python Tools/cook_convex_asset.py \
  ...
  --output Sources/GPUSimDemos/Assets/convex/classic/stanford-armadillo.avbdconvex.json \
...
python Tools/cook_convex_asset.py \
  ...
  --output Sources/GPUSimDemos/Assets/convex/classic/utah-teapot.avbdconvex.json \

...
public enum Demos {
    ...
    /// Resolves sample assets in SwiftPM builds and relocated application
    /// bundles. This remains package-scoped because consumers build scenes
    /// through `Demos`, not by coupling to the resource layout.
    package static var resourceBundle: Bundle {
    ...
    @discardableResult
    public static func addGround(_ s: inout PhysicsScene,

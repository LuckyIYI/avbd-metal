...
final class RigidMeshMaterialTests:XCTestCase {
    func testMaterialsSurviveReplicationAndGPUUploadWithSurfaceDetail() throws {
        ...
        scene.addRigidMesh(SceneRigidMesh(body:body,mesh:mesh,color:F3(0.6,0.7,0.8),roughness:0.23,metallic:0.91,surfaceDetail:SIMD4(1,1,0.3,0.0002)))
        ...
        XCTAssertTrue(replicated.rigidMeshes.allSatisfy{$0.roughness==0.23 && $0.metallic==0.91 && $0.surfaceDetail == SIMD4(1,1,0.3,0.0002)})
        ...
        XCTAssertEqual(vertices[0].surfaceDetail,SIMD4(1,1,0.3,0.0002))

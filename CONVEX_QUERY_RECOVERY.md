...
Validation is recorded in the application repository at `out/convex-recurrence-v3/promoted-engine-tests.log` and `cooker-tests.log`. Renderer sources are already represented by PR #33; `PhysicsAVBD` and `SimCore` source trees match the application integration after this promotion.
